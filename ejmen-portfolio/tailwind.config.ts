  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'linear-gradient(135deg, #667eea 0%, #764ba2 25%, #667eea 50%, #f093fb 75%, #f5576c 100%)',
        'aurora': 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
        'cyber': 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 25%, #d946ef 50%, #f472b6 75%, #fb7185 100%)',
      },
      animation: {
      ...
      keyframes: {
        ...
        glow: {
          '0%': { 
            boxShadow: '0 0 5px rgba(99, 102, 241, 0.5), 0 0 10px rgba(99, 102, 241, 0.3), 0 0 15px rgba(99, 102, 241, 0.1)' 
          },
          '100%': { 
      ...
      boxShadow: {
        ...
        'cyber': '0 0 20px rgba(139, 92, 246, 0.3), 0 0 40px rgba(217, 70, 239, 0.2)',
      },
      backdropBlur: {
        xs: '2px',
      },
